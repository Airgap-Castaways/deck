...
For the human-facing reference, read `../docs/reference/step-kinds.md`, `../docs/reference/workflow-model.md`, and `../docs/reference/workspace-layout.md`. Contributor-facing tool-definition details live in `../docs/contributing/tool-definition-schema.md`.
