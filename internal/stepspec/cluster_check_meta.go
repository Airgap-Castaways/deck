	...
	Ask: stepmeta.AskMetadata{
		...
		Builders: []stepmeta.AuthoringBuilder{{
			...
			Bindings: []stepmeta.AuthoringBinding{
				...
				{Path: "spec.nodes.total", From: "override:nodeCount", Required: true},
				{Path: "spec.nodes.total", From: "program:verification.expectedNodeCount", Required: true},
				{Path: "spec.nodes.ready", From: "override:readyCount", Required: true},
				...
				{Path: "spec.nodes.controlPlaneReady", From: "override:controlPlaneReady", Required: true},
