...
var _ = stepmeta.MustRegister[EditTOML](stepmeta.Definition{Kind: "EditTOML", Family: "file", FamilyTitle: "File", Group: "filesystem-content", GroupOrder: 60, DocsPage: "file", DocsOrder: 50, Visibility: "public", Roles: []string{"apply"}, Outputs: []string{"path"}, SchemaFile: "file.edit-toml.schema.json", SchemaPatch: stepmeta.PatchEditTOMLToolSchema, Parallel: parallelTargetPaths("spec.path")})
