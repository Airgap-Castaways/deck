	...
	Ask: stepmeta.AskMetadata{
		...
		Builders: []stepmeta.AuthoringBuilder{{
			...
			Bindings: []stepmeta.AuthoringBinding{
				{Path: "spec.outputJoinFile", From: "override:joinFile"},
				...
				{Path: "spec.podNetworkCIDR", From: "override:podCIDR"},
				{Path: "spec.podNetworkCIDR", From: "program:cluster.podCIDR"},
				{Path: "spec.podNetworkCIDR", From: "derive:cluster.podCIDR"},
				{Path: "spec.kubernetesVersion", From: "override:kubernetesVersion", Required: true},
				{Path: "spec.kubernetesVersion", From: "program:cluster.kubernetesVersion"},
				{Path: "spec.kubernetesVersion", From: "derive:cluster.kubernetesVersion", Required: true},
				{Path: "spec.criSocket", From: "override:criSocket", Required: true},
				{Path: "spec.criSocket", From: "program:cluster.criSocket"},
				{Path: "spec.criSocket", From: "derive:cluster.criSocket", Required: true},
...
var _ = stepmeta.MustRegister[KubeadmJoin](stepmeta.Definition{
	...
	Ask: stepmeta.AskMetadata{
		...
		Builders: []stepmeta.AuthoringBuilder{{
			...
			Bindings: []stepmeta.AuthoringBinding{
				{Path: "spec.joinFile", From: "override:joinFile"},
