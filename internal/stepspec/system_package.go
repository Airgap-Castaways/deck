...
var _ = stepmeta.MustRegister[Swap](stepmeta.Definition{Kind: "Swap", Family: "swap", FamilyTitle: "Swap", DocsPage: "swap", DocsOrder: 10, Visibility: "public", Roles: []string{"apply"}, SchemaFile: "swap.schema.json", SchemaPatch: stepmeta.PatchSwapToolSchema})
...
var _ = stepmeta.MustRegister[Sysctl](stepmeta.Definition{Kind: "Sysctl", Family: "sysctl", FamilyTitle: "Sysctl", DocsPage: "sysctl", DocsOrder: 10, Visibility: "public", Roles: []string{"apply"}, SchemaFile: "sysctl.schema.json", SchemaPatch: stepmeta.PatchSysctlToolSchema})
...
var _ = stepmeta.MustRegister[EnsureDirectory](stepmeta.Definition{Kind: "EnsureDirectory", Family: "directory", FamilyTitle: "Directory", DocsPage: "directory", DocsOrder: 10, Visibility: "public", Roles: []string{"apply"}, Outputs: []string{"path"}, SchemaFile: "directory.schema.json", SchemaPatch: stepmeta.PatchEnsureDirectoryToolSchema})
...
var _ = stepmeta.MustRegister[CreateSymlink](stepmeta.Definition{Kind: "CreateSymlink", Family: "symlink", FamilyTitle: "Symlink", DocsPage: "symlink", DocsOrder: 10, Visibility: "public", Roles: []string{"apply"}, Outputs: []string{"path"}, SchemaFile: "symlink.schema.json", SchemaPatch: stepmeta.PatchCreateSymlinkToolSchema})
...
var _ = stepmeta.MustRegister[RefreshRepository](stepmeta.Definition{Kind: "RefreshRepository", Family: "repository", FamilyTitle: "Repository", DocsPage: "repository", DocsOrder: 20, Visibility: "public", Roles: []string{"apply"}, SchemaFile: "repository.refresh.schema.json", SchemaPatch: stepmeta.PatchRefreshRepositoryToolSchema, Notes: []string{"Use `RefreshRepository` after writing repo definitions and before package installs that depend on fresh metadata."}, Ask: stepmeta.AskMetadata{Capabilities: []string{"repository-setup"}, MatchSignals: []string{"repo", "repository", "metadata", "refresh", "cache", "dnf", "apt"}, KeyFields: []string{"spec.manager", "spec.clean", "spec.update", "spec.restrictToRepos", "spec.excludeRepos"}, ConstrainedLiteralFields: []stepmeta.ConstrainedLiteralField{{Path: "spec.manager", AllowedValues: []string{"auto", "apt", "dnf"}, Guidance: "Keep spec.manager as a literal enum, not a vars template."}}}})
