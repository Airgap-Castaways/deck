...
func RenderGroupPage(in PageInput) []byte {
	...
	buf.WriteString("\n## Shared Step Fields\n\n")
	buf.WriteString("Shared step envelope fields such as `id`, `apiVersion`, `kind`, `when`, `retry`, `timeout`, `register`, and `metadata` are documented in [Workflow Schema](../schema/workflow.md).\n")
	...
	buf.WriteString("- [Schema Reference](../schema/README.md)\n")
	return buf.Bytes()
}
...
func RenderTypedStepsPage(inputs []PageInput) []byte {
	...
	buf.WriteString("Use these pages when you are deciding which kind to author. For raw schema artifacts, see [Schema Reference](schema/README.md).\n\n")
...
func RenderSchemaIndex(workflowPath, toolDefPath string) []byte {
	var buf bytes.Buffer
	buf.WriteString("<!-- Code generated by make generate; DO NOT EDIT. -->\n")
	buf.WriteString("# Schema Reference\n\n")
	buf.WriteString("This is the entrypoint for deck's generated core schema documentation. For typed step selection and field reference, start with [Typed Steps](../typed-steps.md).\n\n")
