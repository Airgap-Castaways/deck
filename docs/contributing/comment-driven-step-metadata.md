...
- `group`: public docs navigation unit used to generate `docs/reference/groups/*.md`
...
Public typed step docs are generated by group. Internal family metadata still matters for registration and schema generation, but public docs should not require operators to understand family names.
