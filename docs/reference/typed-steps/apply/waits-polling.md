...
Wait for files, commands, services, and ports to converge before dependent steps continue.

## Summary

- phase: `apply`
- group: `waits-polling`
- kinds: [WaitForService](#waitforservice), [WaitForFile](#waitforfile), [WaitForMissingFile](#waitformissingfile), [WaitForCommand](#waitforcommand), [WaitForTCPPort](#waitfortcpport), [WaitForMissingTCPPort](#waitformissingtcpport)
...
- kinds: [WaitForService](#waitforservice), [WaitForTCPPort](#waitfortcpport)

### Wait for generated files

- kinds: [WaitForFile](#waitforfile), [WaitForCommand](#waitforcommand)
...
- [WaitForService](#waitforservice): Wait until a systemd service reports active.
- [WaitForFile](#waitforfile): Wait until a file or directory exists.
- [WaitForMissingFile](#waitformissingfile): Wait until a file or directory is absent.
- [WaitForCommand](#waitforcommand): Wait until a command exits successfully.
- [WaitForTCPPort](#waitfortcpport): Wait until a TCP port opens.
- [WaitForMissingTCPPort](#waitformissingtcpport): Wait until a TCP port closes.
