...
|---|---|---:|---|---|---|---|
| `spec.command` | `array<string>` | yes | `` | `` | RunCommand vector to execute. The first element is the binary; remaining elements are arguments. | `[systemctl,restart,containerd]` |
