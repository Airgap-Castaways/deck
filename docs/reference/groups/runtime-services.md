...
Configure container runtimes and manage systemd units and services on the node.
...
Use this group when runtime settings or service state changes must take effect locally during apply.
