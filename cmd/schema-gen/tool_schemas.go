...
func toolSchemaGenerators() map[string]toolSchemaGenerator {
	return map[string]toolSchemaGenerator{
		"artifact":             wrapToolSchema(generateArtifactToolSchema),
		"host-check":           wrapToolSchema(generateHostCheckToolSchema),
		...
		"package.download":     wrapToolSchema(generatePackageDownloadToolSchema),
		"package.install":      wrapToolSchema(generatePackageInstallToolSchema),
		"repository.configure": wrapToolSchema(generateRepositoryConfigureToolSchema),
		"repository.refresh":   wrapToolSchema(generateRepositoryRefreshToolSchema),
		...
		"wait.command":         wrapToolSchema(generateWaitCommandToolSchema),
